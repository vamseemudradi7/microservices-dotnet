...
public class ProductsService : IProductsService
{
  ...
  public ProductsService(IValidator<ProductAddRequest> productAddRequestValidator, IValidator<ProductUpdateRequest> productUpdateRequestValidator, IMapper mapper, IProductsRepository productsRepository, IRabbitMQPublisher rabbitMQPublisher, IServiceBusPublisher serviceBusPublisher, IConfiguration configuration)
  {
  ...
  public async Task<bool> DeleteProduct(Guid productID)
  {
    ...
    if (isDeleted)
    {
      ...
      await _serviceBusPublisher.Publish(_configuration["ServiceBus:ServiceBus_Products_Deletions_Topic"], headers, message);
    }
  ...
  public async Task<ProductResponse?> UpdateProduct(ProductUpdateRequest productUpdateRequest)
  {
    ...
    await _serviceBusPublisher.Publish(_configuration["ServiceBus:ServiceBus_Products_Updates_Topic"], headers, updatedProductResponse);
